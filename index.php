...
<body>
    ...
    <!-- Menu -->
    <div id="menu"></div>
    <?php if($user_session_php == 1){ 
        ?>
    <h1 style="text-align: center; ">Bem vindo <?php echo $user;?>! </h1>
    <img src="imagens/listadecompras.jpg" alt="Bem vindo" id="listimg" style="border-radius: 50%; opacity: 90%;display: block;
  margin-left: auto;
  margin-right: auto;
  margin-top: 20px;
  width: 50%;
